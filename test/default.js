...
testRule(plugin.rule, {
	...
	reject: [
		...
		},
		{
			code: ".0-block {}",
			message:
				'Expected class name "0-block" to start with a valid prefix: "a-", "m-", "o-", "l-", "g-", "h-", "state-". (' +
				plugin.ruleName +
				")",
		},
		{
		...
		},
		{
			code: ".a-block___x {}",
			message:
				'Expected class name "a-block___x" to use only two "_" as element separator. (' +
				plugin.ruleName +
				")",
		},
		{
			code: ".a-block---x {}",
			message:
				'Expected class name "a-block---x" to use only one "--" modifier separator. (' +
				plugin.ruleName +
				")",
		},
		{
...

		{
			code: ".m-__element {}",
			message:
				'Expected class name "m-__element" to use the m-[block]__[element] syntax. (' +
				plugin.ruleName +
				")",
		},
		{
			code: ".m--modifier {}",
			message:
				'Expected class name "m--modifier" to use the m-[block]--[modifier] syntax. (' +
				plugin.ruleName +
				")",
		},
		{
			...
			message:
				'Expected class name "m-block-__element" to use "-" only for composite names. (' +
				plugin.ruleName +
				")",
		},
		{
			...
			message:
				'Expected class name "m-block__-element" to use "-" only for composite names. (' +
				plugin.ruleName +
				")",
		},
		{
			code: ".m-block__element- {}",
			message:
				'Expected class name "m-block__element-" to use "-" only for composite names. (' +
				plugin.ruleName +
				")",
		},
		{
			...
			message:
				'Expected class name "m-block_--modifier" to use "_" only as element separator. (' +
				plugin.ruleName +
				")",
		},
		{
			...
			message:
				'Expected class name "m-block--_modifier" to use "_" only as element separator. (' +
				plugin.ruleName +
				")",
		},
		{
			...
			message:
				'Expected class name "m-block--modifier_" to use "_" only as element separator. (' +
				plugin.ruleName +
				")",
		},
		{
		...
		},
		{
			code: ".state-block {}",
			message:
				'Expected class name "state-block" to use the state-[prefix]-[block]--[state] syntax. Valid state prefixes: "state-a-", "state-m-", "state-o-", "state-l-", "state-g-", "state-h-". (' +
				plugin.ruleName +
				")",
		},
		{
		...
		},
		{
			...
			message:
				'Expected class name "state-a-block_b" to use "_" only as element separator. (' +
				plugin.ruleName +
				")",
		},
		{
